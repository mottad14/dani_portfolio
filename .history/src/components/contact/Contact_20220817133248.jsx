...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_3fjfb17', 'template_4kgjp9o', form.current, 'user_641J0AWGxx4qcKi835yDq')
      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <h4>Email</h4>
            <h5>mottad14@gmail.com</h5>
            <a href="mailto:mottad14@gmail.com" target="_blank">Send a message</a>
          </article>
          <article className="contact__option">
            <RiMessengerLine className='contact__option-icon'/>
            <h4>Messenger</h4>
            <h5>egatortutorials</h5>
            <a href="https://m.me/mottad14" target="_blank">Send a message</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp className='contact__option-icon'/>
            <h4>WhatsApp</h4>
            <h5>+123456789</h5>
            <a href="https://api.whatsapp.com/send?phone=18479029049" target="_blank">Send a message</a>
          </article>
        </div>
